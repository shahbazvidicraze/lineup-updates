        ...
        <div class="modal-content text-center">
            ...
            <div class="modal-body">
                ...
                <div class="d-flex gap-2 justify-content-center">
                    <a href="{{ $type == 'user' ? url('/web/#/main-dashboard-screen') : ($type == 'organization' ? url('/web/#/organization-dashboard-screen') : '#') }}" class="btn btn-blue">Go to Home</a>
...
<script>
    window.addEventListener('DOMContentLoaded', () => {
        // Automatically show success modal if certain condition met
        const urlParams = new URLSearchParams(window.location.search);
        const showSuccess = urlParams.get('redirect_status') === 'succeeded'; // Example: your-site.com/page?success=true
        if (showSuccess) {
